...
class ConfigurableStethoTree : DebugTree {
    ...
    constructor() {
        mConfiguration =
            ConfigurableStethoTree.Configuration.Builder().build()
    }
    ...
    protected override fun log(
        ...
        val peerManager: ConsolePeerManager? = ConsolePeerManager.getInstanceOrNull()
        if (peerManager == null) {
    ...
    class Configuration private constructor(
        ...
        class Builder {
            ...
            fun build(): ConfigurableStethoTree.Configuration {
                return ConfigurableStethoTree.Configuration(
                    mShowTags,
                    mMinimumPriority
                )
            }
