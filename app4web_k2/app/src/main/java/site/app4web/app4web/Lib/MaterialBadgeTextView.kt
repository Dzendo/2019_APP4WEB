...
class MaterialBadgeTextView @JvmOverloads constructor(
    ...
    private fun refreshBackgroundDrawable(targetWidth: Int, targetHeight: Int) {
        ...
        if (text.length == 1) {
            ...
            ViewCompat.setLayerType(this, LAYER_TYPE_SOFTWARE, sr.paint)
    ...
    fun setHighLightMode(isDisplayInToolbarMenu: Boolean) {
        ...
        ViewCompat.setLayerType(this, LAYER_TYPE_SOFTWARE, drawable.paint)
    ...
    private inner class OvalShadow(shadowRadius: Int, circleDiameter: Int) : OvalShape() {
        ...
        init {
            ...
            mRadialGradient = RadialGradient(
                mCircleDiameter / 2, mCircleDiameter / 2,
