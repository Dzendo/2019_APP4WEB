        ...
        fun build(
            ...
            return try {
                if (parent == null) {
                    ...
                    val layoutParams = JasonLayout.autolayout(null, parent, component, root_context)
                    view.layoutParams = layoutParams
                }
                val bgcolor: Int
                ...
                if (style.has("padding")) {
                    padding_left =
                        JasonHelper.pixels(root_context, style.getString("padding"), "horizontal")
                            .toInt()
                ...
                if (style.has("padding_top")) {
                    padding_top =
                        JasonHelper.pixels(root_context, style.getString("padding_top"), "vertical")
                            .toInt()
                }
                ...
                if (style.has("corner_radius")) {
                    ...
                    var color = ContextCompat.getColor(root_context!!, android.R.color.transparent)
                ...
                try {
                    if (component.has("action")) {
                        ...
                        while (cursor.parent != null) {
                            ...
                            cursor = if (item != null && (item.has("action") || item.has("href"))) {
