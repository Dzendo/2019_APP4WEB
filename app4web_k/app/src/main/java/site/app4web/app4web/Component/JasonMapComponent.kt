    ...
    var touchListener: SimpleOnItemTouchListener = object : SimpleOnItemTouchListener() {
        ...
        override fun onInterceptTouchEvent(
            ...
            if (rv.findChildViewUnder(e.x, e.y) is LinearLayout) {
                val layout =
                    rv.findChildViewUnder(e.x, e.y) as LinearLayout?
                if (layout != null) {
            ...
            try {
                ...
                if (component.has("region")) {
                    ...
                    if (region.has("width") && region.has("height")) {
                        ...
                        val viewWidth =
                            view.layoutParams.width / metrics.density.toDouble()
                        val viewHeight =
                            view.layoutParams.height / metrics.density.toDouble()
                        var meters = width
                        ...
                        val zoom =
                            getZoomForMetersWide(meters, viewWidth, lat).toFloat()
                    ...
                    try {
                        ...
                        if (pinJSONObject!!.has(JasonComponent.Companion.ACTION_PROP)) {
                            ...
                            intent.putExtra(
                                ...
                                pinJSONObject[JasonComponent.Companion.ACTION_PROP]
                                    .toString()
                            )
                            intent.putExtra(
                            ...
                            href.put(
                                ...
                                pinJSONObject[JasonComponent.Companion.HREF_PROP].toString()
                            )
                            intent.putExtra(
                                JasonComponent.Companion.ACTION_PROP,
                                pinJSONObject[JasonComponent.Companion.ACTION_PROP]
