...
class ConfigurableStethoTree : Timber.DebugTree {
    private val mConfiguration // см класс ниже здесь же
            : ConfigurableStethoTree.Configuration

    constructor() {
        mConfiguration = ConfigurableStethoTree.Configuration.Builder().build()
    }

    constructor(configuration: ConfigurableStethoTree.Configuration) {
    ...
    class Configuration private constructor(
        val mShowTags: Boolean,
        val mMinimumPriority: Int
    ) {
        class Builder {
             ...
             */
            fun showTags(showTags: Boolean): ConfigurableStethoTree.Configuration.Builder {
                mShowTags = showTags
                return this
            }
             ...
             * @return Это [Builder] экземпляр.
             */
            fun minimumPriority(priority: Int): ConfigurableStethoTree.Configuration.Builder {
                mMinimumPriority = priority
                return this
            }

            fun build(): ConfigurableStethoTree.Configuration {
                return ConfigurableStethoTree.Configuration(mShowTags, mMinimumPriority)
            }
        }
    }
}