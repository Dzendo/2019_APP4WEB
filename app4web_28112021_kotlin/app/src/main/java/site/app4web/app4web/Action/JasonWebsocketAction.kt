...
class JasonWebsocketAction {
    fun open(action: JSONObject?, data: JSONObject?, event: JSONObject?, context: Context) {
    ...
    fun send(action: JSONObject?, data: JSONObject?, event: JSONObject?, context: Context) {
        (context.applicationContext as Launcher).call(
            "JasonWebsocketService",
            "send",
            action,
