...
import static site.app4web.app4web.Action.JasonGeoAction.COORDS_STRING_FORMAT;
                        ...
                        if (child.getClass().equals(MapView.class)) {
                            ...
                            if (e.getX() > left && e.getX() < right && e.getY() > top && e.getY() < bottom) {
                                switch (e.getActionMasked()) {
                                    ...
                                    // Нажата на карте: остановить просмотр списка от прокрутки
                                    case MotionEvent.ACTION_DOWN:
                                        rv.requestDisallowInterceptTouchEvent(true);
                                        break;

                                    // Released on map or cancelled: listview can be normal again
                                    // Выпущено на карту или отменено: просмотр списка снова может быть нормальным
